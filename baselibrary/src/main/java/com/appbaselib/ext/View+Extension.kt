...
import com.framework.ext.SimpleTextWatcher
 ...
 * @return Unit
 */
fun <T : View> T.click(time: Long = 0,block: (T) -> Unit) = setOnClickListener {
    triggerDelay = time
...
fun TextView.textChange(before:((s:String)->Unit)?=null,after:((s:String)->Unit)?=null,next: (s: String) -> Unit) {
