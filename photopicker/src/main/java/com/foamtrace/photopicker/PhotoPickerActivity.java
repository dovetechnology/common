...
public class PhotoPickerActivity extends AppCompatActivity {
     ...
     * 默认最大照片数量
     */
    public static final int DEFAULT_MAX_TOTAL = Integer.MAX_VALUE;
    /**
     * 是否显示相机，boolean类型
     */
    public static final String EXTRA_SHOW_CAMERA = "show_camera";
    public static final String EXTRA_SMALL_LIMIT = "small_limit";
    /**
     * 默认选择的数据集
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsLimit = getIntent().getBooleanExtra(EXTRA_SMALL_LIMIT, false);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (mImageAdapter.isShowCamera()) {
                    ...
                    if (i == 0) {
                        ...
                        if (mIsLimit && (image.width < 300 || image.width * image.height < 200000)) {
                            Toast.makeText(mCxt, "图片太小了，请选择大一点的图片", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    ...
                    // 正常操作
                    Image image = (Image) adapterView.getAdapter().getItem(i);
                    if (image.width < 300 || image.width * image.height < 150000) {
                        Toast.makeText(mCxt, "图片太小了，请选择大一点的图片", Toast.LENGTH_SHORT).show();
                        return;
                    }
        ...
        btnPreview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (resultList == null || resultList.size() == 0) {
                    String mS = "请选择图片";
                    Toast.makeText(PhotoPickerActivity.this, mS, Toast.LENGTH_SHORT);
                    return;
                }
    ...
    private void initViews() {
        ...
        // ActionBar Setting
        mTextViewmClose = findViewById(R.id.tvClose);
        mTextViewmClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        menuDoneItem = findViewById(R.id.rtvNext);
        menuDoneItem.setVisibility(View.INVISIBLE);
        menuDoneItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                complete();
            }
    ...
    private void refreshActionStatus() {
        String text = getString(R.string.done_with_count, resultList.size());
        menuDoneItem.setText(text);
        boolean hasSelected = resultList.size() > 0;
        if (hasSelected)
            menuDoneItem.setVisibility(View.VISIBLE);
        else
            menuDoneItem.setVisibility(View.INVISIBLE);
            ...
            if (data != null) {
                ...
                if (count > 0) {
                    ...
                    do {
                        ...
                        Image image = new Image(path, name, dateTime, size, width, height);
                        images.add(image);
                        if (!hasFolderGened) {
                            // 获取文件夹名称
